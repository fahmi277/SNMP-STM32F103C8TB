#include <Arduino.h>
#line 1 "d:\\Project\\Arduino\\STM32CORE\\snmp\\snmp.ino"
#line 1 "d:\\Project\\Arduino\\STM32CORE\\snmp\\snmp.ino"
/**
...
#line 66 "d:\\Project\\Arduino\\STM32CORE\\snmp\\snmp.ino"
void pduReceived();
#line 204 "d:\\Project\\Arduino\\STM32CORE\\snmp\\snmp.ino"
void setup();
#line 228 "d:\\Project\\Arduino\\STM32CORE\\snmp\\snmp.ino"
void loop();
#line 66 "d:\\Project\\Arduino\\STM32CORE\\snmp\\snmp.ino"
void pduReceived()
{
...
//  #endif
  ...
  if ( pdu.type == SNMP_PDU_GET || pdu.type == SNMP_PDU_GET_NEXT || pdu.type == SNMP_PDU_SET
    ...
    if ( strcmp_P(oid, sysDescr ) == 0 ) {
      ...
      //
      #ifdef DEBUG
        Serial1 << F("sysDescr...") << locDescr << F(" ") << pdu.VALUE.size << endl;
      #endif
      ...
      //
      #ifdef DEBUG
        Serial1 << F("sysUpTime...") << locUpTime << F(" ") << pdu.VALUE.size << endl;
      #endif
      ...
      //
      #ifdef DEBUG
        Serial1 << F("sysName...") << locName << F(" ") << pdu.VALUE.size << endl;
      #endif
      ...
      //
      #ifdef DEBUG
        Serial1 << F("sysContact...") << locContact << F(" ") << pdu.VALUE.size << endl;
      #endif
      ...
      //
      #ifdef DEBUG
        Serial1 << F("sysLocation...") << locLocation << F(" ") << pdu.VALUE.size << endl;
      #endif
      ...
      //
      #ifdef DEBUG
        Serial1  << F("  locServices...") << locServices << F(" ") << pdu.VALUE.size << endl;
      #endif
    } else {
      // oid does not exist
      //
...
void setup()
{
  ...
  if ( api_status == SNMP_API_STAT_SUCCESS ) {
    ...
    delay(10);
    //
    Serial1 << F("SNMP Agent Initalized...") << endl;
    //
    return;
  }
  //
  delay(10);
  //
  Serial1 << F("SNMP Agent Initalization Problem...") << status << endl;
}
